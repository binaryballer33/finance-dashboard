...
type UseCreateTransactionsTableColumnsProps = {
    shouldColumnBeExpandable?: boolean
}

export default function useCreateTransactionsTableColumns(props: UseCreateTransactionsTableColumnsProps = {}) {
    ...
    const columns = useMemo(() => {
        ...
        /* return the columns */
        return [...utilityColumns, ...dataColumns, ...actionColumns] as ColumnDef<Transaction>[]
